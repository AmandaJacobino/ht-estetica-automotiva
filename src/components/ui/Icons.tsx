...
export type IconProps = SVGProps<SVGSVGElement> & {
  ...
  label?: string;
  /** Sets equal width and height in pixels */
  size?: number;
};
...
function resolveIconProps({
  ...
  if (label) {
    return { ...rest, style: mergedStyle, role: 'img', 'aria-label': label };
  }
  return { ...rest, style: mergedStyle, 'aria-hidden': ariaHidden ?? true };
}

export const Ico = {
  Menu: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
  ...
  Whats: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24" fill="currentColor">
  ...
  Arrow: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 12h14M13 6l6 6-6 6" />
    </svg>
  ),
  Plus: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round">
      <path d="M12 5v14M5 12h14" />
    </svg>
  ),
  Check: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 12l5 5L20 7" />
    </svg>
  ),
  Star: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24">
  ...
  Shield: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  Insta: (p: IconProps) => (
    <svg {...resolveIconProps(p)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
